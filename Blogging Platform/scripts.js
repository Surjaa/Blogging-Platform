document.addEventListener('DOMContentLoaded', () => {
    ...
    postForm.addEventListener('submit', (event) => {
        ...
        const tags = postTags.value.trim().split(',').map(tag => tag.trim());
    ...
    function savePost(author, title, description, content, tags, imageUrl) {
        if (editingPostId !== null) {
            ...
            posts.push({ id: postId, author, title, description, content, tags, imageUrl, comments: [] });
        }
    ...
    function renderPosts() {
        ...
        posts.forEach(post => {
            ...
            postElement.innerHTML = `
                ...
                <p>${post.content}</p>
                ${post.imageUrl ? `<img src="${post.imageUrl}" alt="Post Image" class="post-image" onerror="this.onerror=null;this.src='default.jpg';">` : ''}
